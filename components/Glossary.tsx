...
const dimensions: DimensionConfig[] = [
  ...
  // ==========================================
  {
    ...
    nodes: [
      ...
      { id: 'Mini-hidráulica', label: 'Mini-Hidráulica', x: 180, y: 540, r: 32, definition: 'Centrales minihidráulicas o microhidráulicas que aprovechan corrientes de agua locales sin grandes embalses.' },
      { id: 'Baterías', label: 'Baterías', x: 370, y: 570, r: 32, definition: 'Dispositivos de almacenamiento electroquímico (litio, plomo-ácido, etc.) para flexibilidad a corto y mediano plazo.' },
      { id: 'Alm. Térmico', label: 'Alm. Térmico', x: 480, y: 580, r: 32, definition: 'Sistemas que almacenan calor (sales fundidas, tanques de agua caliente) para calefacción o generación posterior.' },
      { id: 'H2 Verde', label: 'H2 Verde', x: 590, y: 570, r: 32, definition: 'Hidrógeno producido a partir de electricidad renovable mediante electrólisis para almacenamiento a largo plazo.' },
      ...
      { id: 'Red Rural', label: 'Red Rural', x: 815, y: 480, r: 32, definition: 'Comunidades energéticas en áreas de baja densidad de población, a menudo con conexiones de red débiles o aisladas.' },
      { id: 'Red Aislada', label: 'Red Aislada', x: 755, y: 540, r: 32, definition: 'Sistemas eléctricos aislados que requieren altos niveles de autosuficiencia y control de frecuencia/voltaje.' },
  ...
  // ==========================================
  {
    ...
    connections: [
      ...
      { fromX: 480, fromY: 310, toX: 310, toY: 200, isCurve: true },
      // Ramas a Subnodos (Con coordenadas corregidas anti-superposición)
      ...
      { fromX: 780, fromY: 270, toX: 870, toY: 210 },
      { fromX: 780, fromY: 270, toX: 870, toY: 300 },
      { fromX: 780, fromY: 270, toX: 810, toY: 150 },
      { fromX: 660, fromY: 180, toX: 760, toY: 130 },
      { fromX: 660, fromY: 180, toX: 730, toY: 70 },
    ...
    nodes: [
      ...
      { id: 'Cooperativa', label: 'Cooperativa', x: 200, y: 550, r: 32, definition: 'Forma jurídica donde los miembros poseen y controlan democráticamente la comunidad bajo el principio de un miembro, un voto.' },
      ...
      { id: 'Un Socio Un Voto', label: 'Un Socio Un Voto', x: 600, y: 560, r: 32, definition: 'La regla democrática básica de las cooperativas donde cada miembro tiene el mismo peso electoral independientemente de su capital.' },
      { id: 'Voto por Consumo', label: 'Voto por Consumo', x: 510, y: 590, r: 32, definition: 'Poder de voto proporcional al consumo anual de energía o a la inversión económica, priorizando la escala de riesgo financiero.' },
      { id: 'Delegación Líquida', label: 'Delegación Líquida', x: 420, y: 590, r: 32, definition: 'Sistema híbrido donde los miembros pueden votar directamente o delegar su representación en expertos, revocable de forma inmediata.' },
      { id: 'Liderazgo Rotativo', label: 'Liderazgo Rotativo', x: 330, y: 560, r: 32, definition: 'Analiza la alternancia periódica de directivos frente a la concentración o permanencia de los mismos líderes.' },
      ...
      { id: 'Canales Formales', label: 'Canales Formales', x: 870, y: 210, r: 32, definition: 'Medios oficiales de comunicación: actas oficiales de asambleas registradas, cartas escritas o asambleas generales.' },
      { id: 'Canales Informales', label: 'Canales Informales', x: 870, y: 300, r: 32, definition: 'Medios ágiles de mensajería (WhatsApp, redes sociales) o comunicación de boca a boca que fortalecen la cercanía.' },
      { id: 'Datos Abiertos', label: 'Datos Abiertos', x: 810, y: 150, r: 32, definition: 'Política de libre acceso para los miembros a los datos de generación, consumo agregado y balances económicos.' },
      { id: 'Capacitación', label: 'Capacitación', x: 760, y: 130, r: 32, definition: 'Capacitación y educación continua de los miembros de la comunidad en habilidades técnicas, administrativas y democráticas.' },
      { id: 'Profesional', label: 'Profesional', x: 730, y: 70, r: 32, definition: 'Nivel en el que la comunidad energética contrata especialistas profesionales externos frente a la dependencia exclusiva del voluntariado.' },
  ...
  // ==========================================
  {
    ...
    nodes: [
      ...
      { id: 'Armonía Regional', label: 'Armonía Regional', x: 180, y: 540, r: 32, definition: 'Alineación de normas y regulaciones entre diferentes países de Iberoamérica para compartir mejores prácticas regulatorias.' },
      ...
      { id: 'Bonos Verdes', label: 'Bonos Verdes', x: 480, y: 580, r: 32, definition: 'Instrumentos de deuda y bonos emitidos por la comunidad o intermediarios cuyos fondos van exclusivamente a proyectos verdes.' },
      { id: 'Subsidios', label: 'Subsidios', x: 590, y: 570, r: 32, definition: 'Aportaciones y financiamiento público no reembolsable del Estado para sufragar la inversión de capital inicial.' },
      ...
      { id: 'Resolución Conflictos', label: 'Resolución Conflictos', x: 815, y: 480, r: 32, definition: 'Procedimientos y mesas de arbitraje para resolver desacuerdos técnicos o comerciales entre la comunidad y el distribuidor (DSO).' },
  ...
  // ==========================================
  {
    ...
    nodes: [
      ...
      { id: 'Co-diseño Tecnol.', label: 'Co-diseño Tecnol.', x: 370, y: 570, r: 32, definition: 'Proceso de codiseño conjunto e instalación física donde los miembros eligen los tipos y ubicaciones de tecnologías.' },
      { id: 'Voto Vinculante', label: 'Voto Vinculante', x: 480, y: 580, r: 32, definition: 'Poder vinculante y voto de la asamblea vecinal en la formulación del reglamento interno, evitando la mera consulta formal.' },
      { id: 'Derecho Veto', label: 'Derecho Veto', x: 590, y: 570, r: 32, definition: 'Poder estatutario de asambleas étnicas o de comités minoritarios vulnerables para bloquear decisiones generales que puedan perjudicar sus derechos.' },
      ...
      { id: 'Lengua y Comunic.', label: 'Lengua y Comunic.', x: 815, y: 480, r: 32, definition: 'Uso de las lenguas nativas locales y formatos accesibles (audios, lectura fácil) en la comunicación del proyecto.' },
